...
$css = file_get_contents('https://calendar.customsigncenter.com/styles/bootstrap.min.css');
$css .= file_get_contents('https://calendar.customsigncenter.com/styles/print_1.css');
$css .= file_get_contents('https://calendar.customsigncenter.com/assets/icomoon/style.css');	
$css .= '<style>i[class^="ic-"]{ font-family: icomoon; }</style>';
...
sendMail($mpdf);
	...
	{	//$data = file_get_contents('php://input');
		...
		*/
		...
		$from = "tturner@customsigncenter.com";
