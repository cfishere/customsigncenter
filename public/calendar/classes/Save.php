...

{
...

	{
		...
		exit('Save class __construct called.');
		$this->init = new Init;
	...
	{		
		...
		{			
			...
			{		
			   ...
			   /* $htmlDoc->loadHtml(mb_convert_encoding($this->init->content, 'HTML-ENTITIES', 'UTF-8'));*/ //htmlentities($str, ENT_QUOTES, 'UTF-8')
			   $string = $this->utf2html($this->init->content);
			   $htmlDoc->loadHtml($string);
