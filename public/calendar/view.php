...
<div class="row" style="padding:5px 20px">
	...
	<form action="" method="post" name="loadCalendar" id="loadCalendarForm">
	 ...
	 <div class="col-md-4 pl-5">
		 ...
		 <form class="form-group"><h5 style="margin: 0 auto 5px auto;color:#8AC72D;font-size: 15px;text-align:center" class="cursive">Search (Job Number or ANY text)</h5>
	...
	<div class="container-fluid">
	<div style="border-color:#E0EBFC; background-color:#F8FBFF; border-radius: 10px; border-style:solid; border-width:2px; padding:10px; margin-bottom:15px; display:block; box-sizing:border-box">
